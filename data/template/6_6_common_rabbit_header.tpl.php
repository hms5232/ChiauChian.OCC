...
0
|| checktplrefresh('./template/rabbit_occ/common/rabbit_header.htm', './template/rabbit_occ/common/header_common.htm', 1511239602, '6', './data/template/6_6_common_rabbit_header.tpl.php', './template/rabbit_occ', 'common/rabbit_header')
|| checktplrefresh('./template/rabbit_occ/common/rabbit_header.htm', './template/default/common/header_qmenu.htm', 1511239602, '6', './data/template/6_6_common_rabbit_header.tpl.php', './template/rabbit_occ', 'common/rabbit_header')
;?>
...
<?php if(!IS_ROBOT) { if($_G['uid']) { } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><div class="rabbit_nv">
<div class="wp">
<div class="hdc cl">
<div id="nv"><?php $mnid = getcurrentnav();?><div class="rabbit_logo"><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2></div>
...
</div></div><?php include template('common/header_userstatus'); if(!empty($_G['setting']['plugins']['jsmenu'])) { ?>
...
<ul class="cl rabbit_mu <?php if($mnid == $navid) { ?>current<?php } ?>" id="" style="display:<?php if($mnid != $navid) { ?>none<?php } ?>">
<?php echo $subnav;?>
</ul>
<?php } } } ?>
</div>
...
<div id="wp" class="wp">
<div class="rabbit_bgwhite" style="padding-right: 50px;padding-left: 50px;width: 1300px;min-width: 1250px;max-width: 1000px;float: right;margin-right: -190px;">
