...
<label><input type="checkbox" name="chkall" class="pc" onclick="if(!($('mdct').innerHTML = modclickcount = checkall(this.form, 'moderate'))) {$('mdly').style.display = 'none';}" />全選</label>
<h6><span>選中</span><strong onclick="$('mdly').className='';" onmouseover="this.title='最大化'" id="mdct"></strong><span>篇: </span></h6>
<p>
<?php if($_G['group']['allowdelpost']) { ?>
<strong><a href="javascript:;" onclick="tmodthreads(3, 'delete');return false;">刪除</a></strong>
<span class="pipe">|</span>
<?php } if($_G['group']['allowmovethread'] && $_G['forum']['status'] != 3) { ?>
<strong><a href="javascript:;" onclick="tmodthreads(2, 'move');return false;">移動</a></strong>
<span class="pipe">|</span>
<?php } if($_G['group']['allowedittypethread']) { ?>
<strong><a href="javascript:;" onclick="tmodthreads(2, 'type');return false;">分類</a></strong>
<?php } if($_G['forum']['status'] == 3 && in_array($_G['adminid'], array('1','2'))) { ?>
<span class="pipe">|</span>
<strong><a href="javascript:;" onclick="tmodthreads(5, 'recommend_group');return false;">推薦到版塊</a></strong>
...
<a href="javascript:;" onclick="tmodthreads(1, 'stick');return false;">置頂</a>
<?php } if($_G['group']['allowdigestthread']) { ?>
<a href="javascript:;" onclick="tmodthreads(1, 'digest');return false;">精華</a>
...
<a href="javascript:;" onclick="tmodthreads(1, 'recommend');return false;">推薦</a>
...
<a href="javascript:;" onclick="tmodthreads(4);return false;">關閉打開</a>
<?php } ?>
</p>
</div>