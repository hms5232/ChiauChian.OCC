...
0
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/rabbit_occ/common/header_common.htm', 1531081990, '6', './data/template/6_6_common_header_member_lostpasswd.tpl.php', './template/rabbit_occ', 'common/header_member_lostpasswd')
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/default/common/header_qmenu.htm', 1531081990, '6', './data/template/6_6_common_header_member_lostpasswd.tpl.php', './template/rabbit_occ', 'common/header_member_lostpasswd')
;?>
