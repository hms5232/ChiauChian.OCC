...
0
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/rabbit_occ/common/header_common.htm', 1511922550, '6', './data/template/6_6_common_header_forum_guide.tpl.php', './template/rabbit_occ', 'common/header_forum_guide')
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/default/common/header_qmenu.htm', 1511922550, '6', './data/template/6_6_common_header_forum_guide.tpl.php', './template/rabbit_occ', 'common/header_forum_guide')
;?>
