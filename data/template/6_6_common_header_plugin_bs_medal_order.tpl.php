...
0
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/rabbit_occ/common/header_common.htm', 1517144986, '6', './data/template/6_6_common_header_plugin_bs_medal_order.tpl.php', './template/rabbit_occ', 'common/header_plugin_bs_medal_order')
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/default/common/header_qmenu.htm', 1517144986, '6', './data/template/6_6_common_header_plugin_bs_medal_order.tpl.php', './template/rabbit_occ', 'common/header_plugin_bs_medal_order')
;?>
