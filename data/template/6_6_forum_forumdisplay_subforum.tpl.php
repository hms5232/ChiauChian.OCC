...
<?php if(empty($sub['redirect'])) { ?><dd><em>主題: <?php echo dnumber($sub['threads']); ?></em>, <em>帖數: <?php echo dnumber($sub['posts']); ?></em></dd><?php } ?>
<dd>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $sub['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">最後發表: <?php echo $sub['lastpost']['dateline'];?></a>
<?php } } else { ?>
從未
<?php } } ?>
...
<?php if($sub['description']) { ?><p class="xg2"><?php echo $sub['description'];?></p><?php } if($sub['subforums']) { ?><p>子版塊: <?php echo $sub['subforums'];?></p><?php } if($sub['moderators']) { ?><p>版主: <?php echo $sub['moderators'];?></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_subforum_extra'][$sub[fid]])) echo $_G['setting']['pluginhooks']['forumdisplay_subforum_extra'][$sub[fid]];?>
</td>
<td class="fl_i">
