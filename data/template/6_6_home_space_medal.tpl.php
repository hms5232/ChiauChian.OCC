...
<div class="bm bw0">
<h1 class="mt">
<img src="<?php echo STATICURL;?>image/feed/medal.gif" alt="勳章" class="vm" />
<?php if($_GET['action'] == 'log') { ?>我的勳章
<?php } else { ?>勳章中心<?php } ?>
</h1>
...
<p class="emp">您已經獲得所有勳章了，恭喜您！</p>
<?php } else { ?>
<p class="emp">沒有可用的勳章</p>
<?php } } if($lastmedals) { ?>
...
<a href="home.php?mod=space&amp;uid=<?php echo $lastmedal['uid'];?>" class="xi2"><?php echo $lastmedalusers[$lastmedal['uid']]['username'];?></a> 在 <?php echo $lastmedal['dateline'];?> 獲得 <strong><?php echo $medallist[$lastmedal['medalid']]['name'];?></strong> 勳章
</li>
<?php } ?>
</ul>
...
我在 <?php echo $medallog['dateline'];?> 申請了 <strong><?php echo $medallog['name'];?></strong> 勳章,<?php if($medallog['type'] == 2) { ?>等待審核<?php } elseif($medallog['type'] == 3) { ?>未通過審核<?php } } elseif($medallog['type'] != 2 && $medallog['type'] != 3) { ?>
我在 <?php echo $medallog['dateline'];?> 被授予了 <strong><?php echo $medallog['name'];?></strong> 勳章,<?php if($medallog['expiration']) { ?>有效期: <?php echo $medallog['expiration'];?><?php } else { ?>永久有效<?php } } ?>
</li>
<?php } ?>
</ul>
<?php if($multipage) { ?><div class="pgs cl mtm"><?php echo $multipage;?></div><?php } } else { ?>
<p class="emp">您還沒有獲得過勳章</p>
<?php } } ?>
</div>
</div>
<div class="appl">
...
<ul>
<li<?php if(empty($_GET['action'])) { ?> class="a"<?php } ?>><a href="home.php?mod=medal">勳章中心</a></li>
<li<?php if($_GET['action'] == 'log') { ?> class="a"<?php } ?>><a href="home.php?mod=medal&amp;action=log">我的勳章</a></li>
