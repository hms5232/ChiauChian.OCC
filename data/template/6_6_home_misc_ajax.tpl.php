...
<p class="btn_line">
<?php if($rule['credit']) { ?>積分 <strong>+<?php echo $rule['credit'];?></strong> <?php } if($rule['experience']) { ?>經驗 <strong>+<?php echo $rule['experience'];?></strong> <?php } ?>
</p>
<?php if($rule['cyclenum']) { ?>
<p>
本週期內，您還有 <?php echo $rule['cyclenum'];?> 次機會
</p>
<?php } ?>
</div>
