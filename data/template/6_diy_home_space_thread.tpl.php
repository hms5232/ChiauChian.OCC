...
0
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/userabout.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_userabout.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/rabbit_occ/common/header_common.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_diy.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header_personalnv.htm', 1512724512, 'diy', './data/template/6_diy_home_space_thread.tpl.php', './template/rabbit_occ', 'home/space_thread')
;?>
<?php $filter = array( 'common' => '已發表', 'save' => '草稿箱', 'close' => '已關閉', 'aduit' => '待審核', 'ignored' => '已忽略', 'recyclebin' => '回收站');
...
<div class="bm">
<div class="bm_h">
<?php if($space['self']) { ?><span class="xi2 y"><a href="forum.php?mod=misc&amp;action=nav" onclick="showWindow('nav', this.href, 'get', 0)" class="addnew">發帖</a></span><?php } ?>
<h1 class="mt">
<?php if($_GET['type'] == 'reply') { ?>
<span class="xs1 xw0"><a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=thread&amp;uid=<?php echo $space['uid'];?>&amp;from=space">主題</a><span class="pipe">|</span></span>回復
<?php } else { ?>
主題<span class="xs1 xw0"><span class="pipe">|</span><a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=reply&amp;uid=<?php echo $space['uid'];?>&amp;from=space">回復</a></span>
<?php } ?>
</h1>
</div>
<div class="bm_c">
...
<p class="pbm bbda xg1 cl"><a href="javascript:;" class="unfold" id="a_app_more" onclick="userapp_open();">展開</a></p>
...
<?php } ?>
<a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=thread" <?php echo $orderactives['thread'];?>>主題</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=reply" <?php echo $orderactives['reply'];?>>回復</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=postcomment" <?php echo $orderactives['postcomment'];?>>點評</a>
...
<a href="home.php?mod=space&amp;do=thread&amp;view=all&amp;order=hot" <?php echo $orderactives['hot'];?>>熱門帖子</a>
</p>
<?php } } if($diymode && !$_G['setting']['homepagestyle'] ) { ?>
<p class="tbmu">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;from=space&amp;type=thread" <?php echo $orderactives['thread'];?>>主題</a>
<span class="pipe">|</span>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;from=space&amp;type=reply" <?php echo $orderactives['reply'];?>>回復</a>
</p>
<?php } if($userlist) { ?>
<p class="tbmu bw0">
按好友查看
...
<td class="o">&nbsp;</td>
<?php } ?>
<th><?php if($viewtype == 'reply' || $viewtype == 'postcomment') { ?>帖子<?php } else { ?>主題<?php } ?></th>
<td class="frm">版塊<?php if($actives['me'] && $space['uid'] == $_G['uid']) { ?>/群組<?php } ?></td>
...
<td class="icn">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;highlight=<?php echo $index['keywords'];?>" title="新窗口打開" target="_blank">
...
<img src="<?php echo IMGDIR;?>/digest_<?php echo $thread['digest'];?>.gif" alt="精華 <?php echo $thread['digest'];?>" align="absmiddle" />
<?php } if($thread['attachment'] == 2) { ?>
<img src="<?php echo STATICURL;?>image/filetype/image_s.gif" alt="圖片附件" align="absmiddle" />
...
<?php } } } else { ?>
<tr>
<td colspan="<?php if($viewtype != 'postcomment') { if(($_GET['view'] == 'all' && $pruneperm && !$_GET['archiveid'])) { ?>6<?php } else { ?>5<?php } } else { ?>3<?php } ?>"><p class="emp">還沒有相關的帖子</p></td>
</tr>
<?php } ?>
</table>
...
<p class="mtm pns">
<label for="chkall" onclick="checkall(this.form, 'moderate')"><input type="checkbox" name="chkall" id="chkall" class="pc vm" />全選</label>
<button type="submit" name="delsubmit" value="true" class="pn vm"><em>刪除選中主題</em></button>
</p>
<?php } ?>
</form>

<?php if($hiddennum) { ?>
<p class="mtm">本頁有 <?php echo $hiddennum;?> 篇帖子因隱私問題而隱藏</p>
<?php } ?>
</div>
