...
<?php } ?>
<a href="forum.php?mod=guide&amp;view=my" title="我的帖子" class="xi2">我的帖子</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="最新回復" class="xi2">最新回復</a><?php } ?>
</div>
</div>
<?php } ?>
...
#onlinelist li .wv_online_gmember{border: 1px solid #b9b9b9;}
                        ...
                        <!--�����б���ʾͷ�� by �������--><?php if($whosonline) { ?>
                                <?php if(is_array($whosonline)) foreach($whosonline as $key => $online) { ?>                                        <li title="時間: 

<?php echo $online['lastactivity'];?><?php echo "\n";?>操作: <?php echo $online['action'];?> <?php if($online['fid']) { ?><?php echo "\n";?>版塊: <?php echo $online['fid'];?><?php } ?>">
                                        <?php if($online['uid']!=0) { ?>
