...
<span>
<a href="javascript:;" class="flbc" onclick="hideWindow('nav')" title="關閉">關閉</a>
</span>
<?php } ?>
</h3>
...
<button id="postbtn" class="pn pnc y" onclick="hideWindow('nav');showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=' + selectfid)" disabled="disabled"><span>發新帖</span></button>
<?php } else { ?>
...
<?php } } ?>
<span class="pbnv"><?php echo $_G['setting']['bbname'];?><span id="pbnv"></span> <a id="enterbtn" class="xg1" href="javascript:;" onclick="locationforums(currentblock, currentfid)">[進入版塊]</a></span>
</p>
<ul class="pbl cl">
...
var s = '<?php if($commonfids) { ?><p><a id="commonforum" href="javascript:;" onclick="switchforums(this, 1, \'common\')" class="pbsb lightlink">常用版塊</a></p><?php } ?>';
