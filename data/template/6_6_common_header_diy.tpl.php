...
<ul>
<li><a href="javascript:;" onclick="spaceDiy.recover();return false;" title="恢復備份">恢復備份</a></li>
<li><a href="javascript:;" onclick="drag.frameExport();return false;" title="導出當前頁面中所有DIY數據">導出</a></li>
<li><a href="javascript:;" onclick="drag.openFrameImport();$('button_more_menu').style.display='none';return false;" title="將DIY數據導入到當前頁面">導入</a></li>
<li><a href="javascript:;" onclick="drag.blockForceUpdateBatch();$('button_more_menu').style.display='none';return false;" title="更新當前頁面所有模塊的數據">更新</a></li>
<li><a href="javascript:;" onclick="drag.clearAll();$('button_more_menu').style.display='none';return false;" title="清空頁面上所在DIY數據">清空</a></li>
</ul>
</div>
<div id="controlpanel" class="cl hide">
<div id="controlheader" class="cl">
<p class="y">
<span id="navcancel"><a href="javascript:;" id="diycancel" onclick="spaceDiy.cancel();return false;">關閉</a></span>
...
<span id="preview" class="unusable"><a href="javascript:;" onclick="spaceDiy.save('preview');return false;" onfocus="this.blur();" title="預覽DIY的效果" id="diy_preview">預覽</a></span>
...
<li id="navblockclass"><a href="javascript:;" onclick="spaceDiy.getdiy('blockclass');this.blur();return false;" id="hd_mod">模塊</a></li>
<?php if(!empty($topic)) { ?>
<li id="navstyle"><a href="javascript:;" onclick="spaceDiy.getdiy('style');this.blur();return false;">風格</a></li>
<li id="navdiy"><a href="javascript:;" onclick="spaceDiy.getdiy('diy', 'topicid', '<?php echo $topic['topicid'];?>');this.blur();return false;">自定義</a></li>
<?php } ?>
</ul>
<div id="diy_backup_tip" class="tip tip_2" style="display: none;">
<div class="tip_horn"></div>
<div class="tip_c">您可以通過導出進行模板備份 &nbsp; <a href="javascript:;" class="xi2" onclick="drag.saveViewTip('diy_backup_tip');return false;">我知道了</a></div>
</div>
</div>
...
<ul id="contentstart" class="content">
  ...
  <li><a href="javascript:;" onclick="spaceDiy.getdiy('blockclass');return false;"><img src="<?php echo STATICURL;?>image/diy/module.png" />添加模塊</a></li>
  <?php if(!empty($topic)) { ?>
...
<span class="y"><a href="javascript:;" onclick="spaceDiy.cancel();return false;" class="xi2">關閉</a>&nbsp;&nbsp;</span>
當前為<strong>簡潔模式</strong>，您可以更新模塊，修改模塊屬性和數據，要使用完整的拖拽功能，<a href="javascript:;" onclick="spaceDiy.init();" class="xw1 xi2">請點擊進入高級模式</a>
</div>
