...
<!--<p><a class="grey" href="<?php echo $url_forward;?>">點擊此鏈接進行跳轉</a></p>-->
...
<p><input type="button" class="button" onclick="popup.close();" value="關閉"></p>
<?php } ?>
</dt>
</div>
<?php } else { ?>
...
<p><a class="grey" href="<?php echo $url_forward;?>">點擊此鏈接進行跳轉</a></p>
<?php } elseif($allowreturn) { ?>
<p><a class="grey" href="javascript:history.back();">[ 點擊這裡返回上一頁 ]</a></p>
<?php } ?>
</div>
<!-- main jump end -->
