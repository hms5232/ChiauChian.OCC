...
<div class="f_c">
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">主題操作記錄</em>
<span>
...
<td><?php if($log['uid']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $log['uid'];?>" target="_blank"><?php echo $log['username'];?></a><?php } else { ?>任務系統<?php } ?></td>
