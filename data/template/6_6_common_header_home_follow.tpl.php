...
0
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/rabbit_occ/common/header_common.htm', 1511864827, '6', './data/template/6_6_common_header_home_follow.tpl.php', './template/rabbit_occ', 'common/header_home_follow')
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/default/common/header_qmenu.htm', 1511864827, '6', './data/template/6_6_common_header_home_follow.tpl.php', './template/rabbit_occ', 'common/header_home_follow')
;?>
