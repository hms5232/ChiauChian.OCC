...
0
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_pm_node.htm', 1538212833, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/rabbit_occ', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/common/seditor.htm', 1538212833, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/rabbit_occ', 'home/space_pm')
|| checktplrefresh('./template/default/home/space_pm.htm', './template/default/home/space_prompt_nav.htm', 1538212833, 'diy', './data/template/6_diy_home_space_pm.tpl.php', './template/rabbit_occ', 'home/space_pm')
;?>
...
<ul class="tb cl">
<li class="y"><a href="home.php?mod=space&amp;do=pm&amp;subop=setting" class="xi2">短消息設置</a></li>
...
<li class="o"><a href="home.php?mod=spacecp&amp;ac=pm">發送消息</a></li>
</ul>

<?php if(($filter == 'privatepm' && $newpm) || $filter == 'newpm') { ?>
<div class="tbms mtm mbm">
<?php if($filter != 'newpm') { ?>
<a href="home.php?mod=space&amp;do=pm&amp;filter=newpm" class="xi2">點擊這裡查看 <strong class="xi1"><?php echo $newpmcount;?></strong> 條未讀消息</a>
<?php } else { ?>
...
<div class="y pm_o">
<a href="javascript:;" id="pm_operation" class="o" onmouseover="showMenu({'ctrlid':this.id, 'pos':'34'})">菜單</a>
<div id="pm_operation_menu" class="p_pop" style="display: none;">
<ul>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=delete&amp;deletepm_delplid[]=<?php echo $plid;?>&amp;plid=<?php echo $plid;?>&amp;handlekey=pmdeletehk_<?php echo $plid;?>" id="a_pmdelete_<?php echo $plid;?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="刪除與該用戶的所有私人消息">全部刪除</a></li>
</ul>
</div>
</div>
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=export&amp;plid=<?php echo $plid;?>" class="xw1">[導出]</a>
</div>
<?php } elseif($touid) { ?>
<div class="tbmu pml pm_op_r cl">
<div class="y pm_o">
...
<div id="pm_operation_menu" class="p_pop" style="display: none;">
<ul>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=delete&amp;deletepm_deluid[]=<?php echo $touid;?>&amp;uid=<?php echo $touid;?>&amp;handlekey=pmdeletehk_<?php echo $plid;?>" id="a_pmdelete_<?php echo $plid;?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="刪除與該用戶的所有私人消息">全部刪除</a></li>
</ul>
</div>
</div>
<div class="xw1">
共有 <span id="membernum" class="xi1"><?php echo $count;?></span> 條與 <a href="home.php?mod=space&amp;uid=<?php echo $touid;?>"><?php echo $tousername;?></a> 的交談記錄 &nbsp;
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=export&amp;touid=<?php echo $touid;?>">[導出]</a>
</div>
</div>
<?php } else { ?>
...
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=delete&amp;deletepm_delplid[]=<?php echo $plid;?>&amp;plid=<?php echo $plid;?>&amp;handlekey=pmdeletehk_<?php echo $plid;?>" id="a_pmdelete_<?php echo $plid;?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="刪除該群聊話題">刪除群聊</a></li>
<?php } else { ?>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=delete&amp;deletepm_quitplid[]=<?php echo $plid;?>&amp;plid=<?php echo $plid;?>&amp;handlekey=pmdeletehk_<?php echo $plid;?>" id="a_pmdelete_<?php echo $plid;?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="退出該群聊話題">退出群聊</a></li>
<?php } ?>
</ul>
</div>
</div>
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;plid=<?php echo $plid;?>&amp;type=1&amp;daterange=2"<?php if($list && $daterange && !$touid) { ?> class="a"<?php } ?>>群聊首頁</a>
<span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;plid=<?php echo $plid;?>&amp;type=1#last"<?php if($list && !$daterange) { ?> class="a"<?php } ?>>群聊記錄</a>
<span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;chatpmmember=1&amp;plid=<?php echo $plid;?>&amp;type=1" id="a_pmdelete_<?php echo $plid;?>"<?php if($chatpmmemberlist && !$daterange) { ?> class="a"<?php } ?> <?php echo $actives['chatpmmember'];?>><?php if($authorid == $_G['uid']) { ?>管理成員<?php } else { ?>成員列表<?php } ?></a>
<span class="pipe">|</span>
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=export&amp;plid=<?php echo $plid;?>&amp;type=1" class="xw1">[導出]</a>
</div>
<?php } if($list && $daterange && !$touid) { if(empty($lastanchor)) { ?><a name="last"></a><?php $lastanchor=1;?><?php } ?>
<div class="pm_g cl">
<h2 class="mbm xs2"><span class="xi1"><?php echo $membernum;?></span> 人話題 : <span class="xi2"><?php echo $subject;?></span></h2>
<div class="pm_sd">
<ul class="pm_mem_l<?php if($authorid == $_G['uid']) { ?> pm_admin<?php } ?>"><?php if(is_array($chatpmmemberlist)) foreach($chatpmmemberlist as $key => $value) { ?><li><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" target="_blank" <?php if($ols[$value['uid']]) { ?> class="xi2" title="在線"<?php } else { ?> class="xg1"<?php } ?>><?php echo $value['username'];?></a></li>
<?php } ?>
</ul>
...
<span class="z">&nbsp;</span>
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=appendmember&amp;plid=<?php echo $plid;?>" id="a_appendmember" class="pn z" title="加入新的成員" onclick="getchatpmappendmember();"><span>+</span></a>
</div>
<?php } ?>
</div>
<div class="pm_mn">
...
pObj.innerHTML = '<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" class="xi2"><?php echo $_G['username'];?></a> &nbsp;'+ "剛剛";
...
<?php if($refreshtime) { ?>
$('refreshtip').innerHTML = autorefresh + ' 秒後刷新';
<?php } ?>
autorefresh -= 2;
} else {
...
<dd class="y mtm pm_o">
<a href="javascript:;" id="pm_o_<?php echo $value['pmid'];?>" class="o" onmouseover="showMenu({'ctrlid':this.id, 'pos':'34'})">菜單</a>
<div id="pm_o_<?php echo $value['pmid'];?>_menu" class="p_pop" style="display: none;">
<ul>
<?php if($value['pmtype'] == 1) { ?>
<li><a href="javascript:;" id="a_pmdelete_<?php echo $value['pmid'];?>" onclick="ajaxget('home.php?mod=spacecp&ac=pm&op=delete&deletepm_pmid[]=<?php echo $value['pmid'];?>&touid=<?php echo $touid;?>&deletesubmit=1&handlekey=pmdeletehk_<?php echo $value['pmid'];?>&formhash=<?php echo FORMHASH;?>', '', 'ajaxwaitid', '', 'none', 'changedeletedpm(<?php echo $value['pmid'];?>)');" title="刪除">刪除</a></li>
<?php } if($value['authorid'] && $value['authorid'] != $_G['uid'] && $_G['setting']['pmreportuser']) { ?>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=pm_report&amp;pmid=<?php echo $value['pmid'];?>&amp;handlekey=pmreporthk_<?php echo $value['pmid'];?>" id="a_pmreport_<?php echo $value['pmid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="舉報">舉報</a></li>
<?php } ?>
</ul>
</div>
</dd>
...
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=appendmember&amp;plid=<?php echo $plid;?>" id="a_appendmember" class="pn appendmb z" title="加入新的成員" onclick="getchatpmappendmember();"><span class="z">加入新的成員</span></a>
<a href="javascript:;" id="showSelectBox" class="z mtn showmenu" onclick="showMenu({'showid':this.id, 'duration':3, 'pos':'34!'});fs.showPMFriend('showSelectBox_menu','selectorBox', this);" title="從好友列表中選擇">選擇好友</a>
</div>
<p class="d">多個用戶使用逗號、分號或回車提示系統分開</p>
</div>
...
<div class="cl">
<button type="button" class="y pn" onclick="fs.showPMFriend('showSelectBox_menu','selectorBox', $('showSelectBox'));doane(event)"><span>關閉</span></button>
</div>
</div>
...
<?php if($authorid == $_G['uid']) { ?>
<p class="xg1"><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=kickmember&amp;memberuid=<?php echo $key;?>&amp;plid=<?php echo $plid;?>" id="a_kickmmeber_<?php echo $key;?>" title="將 <?php echo $value['username'];?> 從該群聊中踢出" onclick="showWindow(this.id, this.href, 'get', 0);">踢出</a></p>
<?php } ?>
</li>
<?php } ?>
</ul>
...
<p class="mtn">
<button type="submit" name="pmsubmit" id="pmsubmit" class="pn pnc" value="true"><strong>發送</strong></button>
...
<dl class="bbda cl">
<dd class="y mtm pm_o">
<a href="javascript:;" id="pm_o_<?php echo $grouppm['id'];?>" class="o" onmouseover="showMenu({'ctrlid':this.id, 'pos':'34'})">菜單</a>
<div id="pm_o_<?php echo $grouppm['id'];?>_menu" class="p_pop" style="display: none;">
<ul>
<li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=delete&amp;deletepm_gpmid[]=<?php echo $grouppm['id'];?>&amp;pmid=<?php echo $grouppm['id'];?>&amp;handlekey=gpmdeletehk_<?php echo $grouppm['id'];?>" id="a_gpmdelete_<?php echo $grouppm['id'];?>" onclick="showWindow(this.id, this.href, 'get', 0);" title="刪除">刪除</a></li>
</ul>
</div>
</dd>
<dd class="m avt">
...
<dd class="ptm">
<?php if($grouppm['author']) { ?>這是由 <a href="home.php?mod=space&amp;uid=<?php echo $grouppm['authorid'];?>" class="xi2" target="_blank"><?php echo $grouppm['author'];?></a> 發送的多人消息<?php } else { ?>這是由系統發送的多人消息<?php } ?>&nbsp; 
...
<?php if($grouppm['author']) { ?>
<p class="ptn xi2">
<a href="home.php?mod=spacecp&amp;ac=pm&amp;touid=<?php echo $grouppm['authorid'];?>">回復 <?php echo $grouppm['author'];?></a>
</p>
<?php } ?>
</dd>
...
<div class="d"><p>添加到該列表中的用戶給您發送短消息時將不予接收</p>
								<p>添加多個忽略人員名單時用逗號 "," 隔開，如「張三,李四,王五」</p>
								<p>如需禁止所有用戶發來的短消息，請設置為 "&#123;ALL&#125;"</p></div>
</td>
</tr>
<tr>
<th></th>
...
<div id="pm_o_<?php echo $grouppm['id'];?>_menu" class="p_pop" style="display: none;">
<ul>
<li><a href="javascript:;" onclick="ajaxget('home.php?mod=spacecp&ac=pm&op=delete&deletesubmit=1&deletepm_gpmid[]=<?php echo $grouppm['id'];?>', '', 'ajaxwaitid', '', 'none', '$(\'gpmlist_<?php echo $grouppm['id'];?>\').style.display=\'none\';');">刪除</a></li>
</ul>
</div>
</dd>
<dd class="m avt">
<div class="newpm_avt" title="有未讀消息"></div>
...
<?php if($grouppm['author']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $grouppm['authorid'];?>" target="_blank"><?php echo $grouppm['author'];?></a> 說 :
<?php } ?>
...
<span class="xi2 xw1">您</span> 對 <a href="home.php?mod=space&amp;uid=<?php echo $value['touid'];?>" target="_blank"><?php echo $value['tousername'];?></a> 說 :<br />
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $value['touid'];?>" target="_blank" class="xw1"><?php echo $value['tousername'];?></a> 對 <span class="xi2">您</span> 說 :<br />
<?php } ?>
...
<ul>
<?php if($value['pmtype'] == 1) { ?>
<li><a href="javascript:;" onclick="ajaxget('home.php?mod=spacecp&ac=pm&op=delete&deletesubmit=1&deletepm_deluid[]=<?php echo $value['touid'];?>', '', 'ajaxwaitid', '', 'none', '$(\'pmlist_<?php echo $value['plid'];?>\').style.display=\'none\';');">刪除</a></li>
...
<?php } elseif($value['pmtype'] == 2) { if($value['authorid'] == $_G['uid']) { ?>
<li><a href="javascript:;" onclick="ajaxget('home.php?mod=spacecp&ac=pm&op=delete&deletesubmit=1&deletepm_delplid[]=<?php echo $value['plid'];?>', '', 'ajaxwaitid', '', 'none', '$(\'pmlist_<?php echo $value['plid'];?>\').style.display=\'none\';');">刪除</a></li>
<?php } else { ?>
<li><a href="javascript:;" onclick="ajaxget('home.php?mod=spacecp&ac=pm&op=delete&deletesubmit=1&deletepm_quitplid[]=<?php echo $value['plid'];?>', '', 'ajaxwaitid', '', 'none', '$(\'pmlist_<?php echo $value['plid'];?>\').style.display=\'none\';');">刪除</a></li>
<?php } } ?>
</ul>
</div>
<span class="xg1 z">共 <?php echo $value['pmnum'];?> 條</span>
<a href="javascript:;" id="pm_o_<?php echo $value['plid'];?>" class="o" onmouseover="showMenu({'ctrlid':this.id, 'pos':'34'})">菜單</a>
 | 
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;touid=<?php echo $value['touid'];?>#last" id="pmlist_<?php echo $value['plid'];?>_a">回復</a>
</span>
<?php } elseif($value['pmtype'] == 2) { ?>
<table>
<tr>
<td valign="top" width="65"><?php echo $value['members'];?> 人話題 :</td>
</tr>
<tr>
<td>
...
<span class="xg1"><?php echo dgmdate($value[lastdateline], 'u');?></span>
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;plid=<?php echo $value['plid'];?>&amp;type=1&amp;daterange=<?php echo $value['daterange'];?>#last">回復</a>
</p>
<?php } ?>
</td>
</tr>
...
<label for="delete_all" onclick="checkall(this.form, 'deletepm_');"><input type="checkbox" name="chkall" id="delete_all" class="pc" />全選</label> &nbsp; 
<button class="pn" type="submit" name="deletepmsubmit_btn" value="true"><strong>刪除</strong></button>
<button class="pn" type="button" name="markreadpm_btn" value="true" onclick="setpmstatus(this.form);"><strong>標記已讀</strong></button>
<?php } ?>
</div>
