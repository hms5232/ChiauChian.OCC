...
<a href="forum.php">首頁</a> | <a href="member.php?mod=logging&amp;action=login" title="登錄">登錄</a> | <a href="<?php if($_G['setting']['regstatus']) { ?>member.php?mod=<?php echo $_G['setting']['regname'];?><?php } else { ?>javascript:;" style="color:#D7D7D7;<?php } ?>" title="<?php echo $_G['setting']['reglinkname'];?>">註冊</a>
<?php } else { ?>
...
<?php } ?>
    ...
    <div>
<a href="<?php echo $_G['setting']['mobile']['simpletypeurl']['0'];?>">標準版</a> |  
<a href="javascript:;" style="color:#D7D7D7;">觸屏版</a> | 
<a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>">電腦版</a> | 
<?php if($clienturl) { ?><a href="<?php echo $clienturl;?>">客戶端</a><?php } ?>
    </div>
