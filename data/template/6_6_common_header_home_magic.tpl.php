...
0
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/rabbit_occ/common/header_common.htm', 1511240414, '6', './data/template/6_6_common_header_home_magic.tpl.php', './template/rabbit_occ', 'common/header_home_magic')
|| checktplrefresh('./template/rabbit_occ/common/header.htm', './template/default/common/header_qmenu.htm', 1511240414, '6', './data/template/6_6_common_header_home_magic.tpl.php', './template/rabbit_occ', 'common/header_home_magic')
;?>
